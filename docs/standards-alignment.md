...
| [RFC 9449](https://www.rfc-editor.org/rfc/rfc9449) DPoP | visor-gateway `DPoP` header, `htm`/`htu`/`ath`/`jti`/`iat`, proof-jti replay | DPoP nonce, DPoP at the STS token endpoint, WPT |
